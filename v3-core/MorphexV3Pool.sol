...
import './interfaces/callback/IMorphexV3MintCallback.sol';
import './interfaces/callback/IMorphexV3SwapCallback.sol';
import './interfaces/callback/IMorphexV3FlashCallback.sol';

import '../v3-lm-pool/interfaces/IMorphexV3LmPool.sol';

contract MorphexV3Pool is IMorphexV3Pool {
    ...
    /// @inheritdoc IMorphexV3PoolImmutables
    ...
    /// @inheritdoc IMorphexV3PoolState
    ...
    // liquidity mining
    IMorphexV3LmPool public lmPool;
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == IMorphexV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IMorphexV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IMorphexV3PoolDerivedState
    ...
    /// @inheritdoc IMorphexV3PoolActions
    ...
    function initialize(uint160 sqrtPriceX96) external override {
        ...
        slot0 = Slot0({
            ...
            feeProtocol: 131074000, // default value for all pools, 2000:2000, store 2 uint32 inside
            unlocked: true
        });
    ...
    function mint(
        ...
        IMorphexV3MintCallback(msg.sender).morphexV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (address(lmPool) != address(0)) {
          lmPool.accumulateRewards(cache.blockTimestamp);
        }
        ...
        if (zeroForOne) {
            ...
            IMorphexV3SwapCallback(msg.sender).morphexV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IMorphexV3FlashCallback(msg.sender).morphexV3FlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IMorphexV3PoolOwnerActions
    ...
    function setLmPool(address _lmPool) external override onlyFactoryOrFactoryOwner {
      lmPool = IMorphexV3LmPool(_lmPool);
