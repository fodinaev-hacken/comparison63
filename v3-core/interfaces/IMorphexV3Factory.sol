...
/// @title The interface for the MorphexSwap V3 Factory
/// @notice The MorphexSwap V3 Factory facilitates creation of MorphexSwap V3 pools and control over the protocol fees
interface IMorphexV3Factory {
    ...
    /// @notice Emitted when LM pool deployer is removed
    event RemovedLmPoolDeployer(address indexed lmPoolDeployer);
    ...
    function removeLmPoolDeployer(address _lmPoolDeployer) external;
