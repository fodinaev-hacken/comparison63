...
/// @title NFTSVG
/// @notice Provides a function for generating an SVG associated with a MorphexSwap NFT
library NFTSVG {
    ...
    function generateSVG(SVGParams memory params) internal pure returns (string memory svg) {
        ...
        msg: "Forged in SVG for MorphexSwap in 2021 by 0xe8ab59d3bcde16a29912de83a90eb39628cfc163",
    ...
    function generateSVGDefs(SVGParams memory params) private pure returns (string memory svg) {
        ...
        string memory color0 = tokenToColorHex(uint256(uint160(params.quoteTokenAddr)), 136);
        string memory color1 = tokenToColorHex(uint256(uint160(params.baseTokenAddr)), 136);
        string memory color2 = tokenToColorHex(uint256(uint160(params.quoteTokenAddr)), 0);
        string memory color3 = tokenToColorHex(uint256(uint160(params.baseTokenAddr)), 0);
        string memory x1 = scale(getCircleCoord(uint256(uint160(params.quoteTokenAddr)), 16, params.tokenId), 0, 255, 16, 274);
        string memory y1 = scale(getCircleCoord(uint256(uint160(params.baseTokenAddr)), 16, params.tokenId), 0, 255, 100, 484);
        string memory x2 = scale(getCircleCoord(uint256(uint160(params.quoteTokenAddr)), 32, params.tokenId), 0, 255, 16, 274);
        string memory y2 = scale(getCircleCoord(uint256(uint160(params.baseTokenAddr)), 32, params.tokenId), 0, 255, 100, 484);
        string memory x3 = scale(getCircleCoord(uint256(uint160(params.quoteTokenAddr)), 48, params.tokenId), 0, 255, 16, 274);
        string memory y3 = scale(getCircleCoord(uint256(uint160(params.baseTokenAddr)), 48, params.tokenId), 0, 255, 100, 484);
