...
import '../../v3-core/interfaces/callback/IMorphexV3FlashCallback.sol';
...
/// @notice An example contract using the MorphexSwap V3 flash function
contract PairFlash is IMorphexV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `MorphexV3FlashCallback`
    function initFlash(FlashParams memory params) external {
        PoolAddress.PoolKey memory poolKey =
            PoolAddress.PoolKey({token0: params.token0, token1: params.token1, fee: params.fee1});
        IMorphexV3Pool pool = IMorphexV3Pool(PoolAddress.computeAddress(deployer, poolKey));
