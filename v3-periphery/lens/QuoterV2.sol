...
contract QuoterV2 is IQuoterV2, IMorphexV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        return IMorphexV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
        ...
        )
    {
        ...
        IMorphexV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
